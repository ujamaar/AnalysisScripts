...
#directory_path ='C:/Users/axel/Desktop/RotaryDisc/Previous versions and misc code/plotting scripts/test_data'

#pdf_name = 'test_data.pdf'
pdf_name = directory_path + '.pdf'
...
#now plotting the data in a figure (with 4 subplots in this case):
        ...
        #to rastorize the figures so that they load quickly
...
#    pp.savefig(dpi=150)
#    
#    #this is just to suppress the (annoying) display of all plots in the console
#    pylab.close(fig)
#    #pylab.clf()
...
#path = directory_path
#
#file_names = [os.path.join(dirpath, f)
#    for dirpath, dirnames, files in os.walk(path)
#    for f in files if f.endswith('.csv')]

file_names = []
for f in os.listdir(directory_path):
    if (f.split()[0][0] != '.'): #to make sure that hidden files are (respectfully) left alone
