...
def read_data_and_generate_plots(file_path,odor_response_time_window, distance_bin_size,speed_threshold):
    ...
    event_data_per_bin = np.zeros((total_number_of_cells,total_number_distance_bins_in_all_env),dtype='int') 
    ...
    place_field_events_each_cell = np.zeros((total_number_of_cells,total_number_distance_bins_in_all_env+2*number_of_environments),dtype='int')
    ...
    for plot_env in range (0,number_of_environments):
        ...
        for env in range (0,number_of_environments):
            ...
            while(first_cell_with_events < 0):
                if ((data_array[cell][plot_env*2]) > 0):
...
#        else:
        read_data_and_generate_plots(mouse_data,odor_response_time_window, distance_bin_size,speed_threshold)
