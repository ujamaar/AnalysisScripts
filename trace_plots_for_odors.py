...
#        figs = []
        ...
        for cell in xrange(total_number_of_cells):
            ...
            cell_figure = graph_this_cell(mouse_ID_and_date,cell,trace_matrices,adjusted_odors,odor_sequence_in_letters,number_of_frames_in_trace_plot,frames_pre_odor_onset,sequence_of_environments,sequence_of_lap_counts,sequence_of_track_lengths)          
...
def graph_this_cell(mouse_ID_and_date,cell_index,trace_matrices,adjusted_odors,odor_sequence_in_letters,number_of_frames_in_trace_plot,frames_pre_odor_onset,sequence_of_environments,sequence_of_lap_counts,sequence_of_track_lengths):
