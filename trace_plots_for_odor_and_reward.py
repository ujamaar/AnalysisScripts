...
def graph_this_cell(pp,mouse_ID_and_date,cell_index,odor_trace_matrices,reward_trace_matrices,adjusted_odors,reduced_adjusted_odor,which_adjusted_odors_to_keep,odor_sequence_in_letters,number_of_frames_in_odor_trace_plot,number_of_frames_in_reward_trace_plot,frames_pre_odor_onset,frames_pre_reward_onset,sequence_of_environments,sequence_of_lap_counts,sequence_of_track_lengths,total_number_of_cells,frame_rate_after_down_sampling):
    ...
    if(number_of_subplots > 1):
        ...
        for ax in axs:
            ...
            generate_subplot(ax,current_subplot,odor_trace_matrices,number_of_frames_in_odor_trace_plot,frames_pre_odor_onset,adjusted_odors,odor_sequence_in_letters,frame_rate_after_down_sampling,0)
            if(which_adjusted_odors_to_keep[current_subplot] == 1):
                ...
                generate_subplot(ax1,reward_current_subplot,reward_trace_matrices,number_of_frames_in_reward_trace_plot,frames_pre_reward_onset,reduced_adjusted_odor,odor_sequence_in_letters,frame_rate_after_down_sampling,1)
        ...
        generate_subplot(axs,0,odor_trace_matrices,number_of_frames_in_odor_trace_plot,frames_pre_odor_onset,adjusted_odors,odor_sequence_in_letters,frame_rate_after_down_sampling,0)
        generate_subplot(ax1,0,reward_trace_matrices,number_of_frames_in_reward_trace_plot,frames_pre_reward_onset,reduced_adjusted_odor,odor_sequence_in_letters,frame_rate_after_down_sampling,1)

#    plt.show()
    pp.savefig()
    plt.close(fig)

def generate_subplot(ax,current_subplot,trace_matrices,number_of_frames_in_trace_plot,frames_pre_onset,adjusted_odors,odor_sequence_in_letters,frame_rate_after_down_sampling,plot_type):
